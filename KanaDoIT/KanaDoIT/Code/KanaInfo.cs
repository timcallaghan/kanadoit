...
namespace Arbaureal.KanaDoIT
{
    public class KanaInfo
    {
        ...
        private string BaseSoundPath = @"/KanaDoIT;component/Sounds/";
    ...
    public class DictionaryKanaInfo : Dictionary<KanaKey, KanaInfo>
    {
        ...
        {
            HiraganaFont = new FontFamily("/KanaDoIT;component/Fonts/PJ_Hiragana.TTF#PJ Hiragana");
            KatakanaFont = new FontFamily("/KanaDoIT;component/Fonts/PJ_Katakana.TTF#PJ Katakana");
        }
